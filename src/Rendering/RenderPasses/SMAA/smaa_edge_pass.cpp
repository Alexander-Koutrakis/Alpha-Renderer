...
SMAAEdgePass::SMAAEdgePass(Device& device, const CreateInfo& info)
    : device{device},
      width{info.width},
      height{info.height},
...
SMAAEdgePass::~SMAAEdgePass() {
    cleanup();
}

void SMAAEdgePass::cleanup() {
...
void SMAAEdgePass::createRenderPass() {
    ...
    if (vkCreateRenderPass(device.getDevice(), &renderPassInfo, nullptr, &renderPass) != VK_SUCCESS) {
        throw std::runtime_error("failed to create SMAA edge render pass!");
    }
}
...
void SMAAEdgePass::createPipeline() {
    ...
    if (vkCreatePipelineLayout(device.getDevice(), &pipelineLayoutInfo, nullptr, &pipelineLayout) != VK_SUCCESS) {
        throw std::runtime_error("failed to create SMAA edge pipeline layout!");
    }
...
void SMAAEdgePass::beginRenderPass(FrameContext& frameContext) {
...
void SMAAEdgePass::endRenderPass(FrameContext& frameContext) {
